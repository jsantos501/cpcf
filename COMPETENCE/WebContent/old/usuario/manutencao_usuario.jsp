...
<html>
  <head>
	...
	<script type="text/javascript" src="/COMPETENCE/js/jquery.tablesorter.min.js"></script>
	<script type="text/javascript" src="/COMPETENCE/js/jquery.tablesorter.pager.js"></script>
	<link rel="stylesheet" type="text/css" href="/COMPETENCE/css/custom.css" />
  ...
  <body>
    ...
    <table cellspacing="0" summary="Tabela de dados dos usuarios">
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>Tokyo</td>
          <td>
            <a href="#"><img src="/COMPETENCE/img/edit.png" width="16" height="16" /></a>
            <a href="#"><img src="/COMPETENCE/img/delete.png" width="16" height="16" /></a>
          </td>
        </tr>
        <tr>
    ...
    <div id="pager" class="pager">
    	<form>
				...
				<img src="/COMPETENCE/img/first.png" class="first"/>
    		<img src="/COMPETENCE/img/prev.png" class="prev"/>
    		<input type="text" class="pagedisplay"/>
    		<img src="/COMPETENCE/img/next.png" class="next"/>
    		<img src="/COMPETENCE/img/last.png" class="last"/>
    	</form>
    </div>
